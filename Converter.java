//class holds instruction, format and opcode
public class Converter {
    ...
    //Function to access the OPTAB for a given instruction
    public static String getFormat(String instr) {

        for (int i = 0; i < OPTAB.length; i++) {

            if (OPTAB[i][0].equals(instr)) {

                return OPTAB[i][1]; // Return the format (1, 2, or 3)

            }

        }

        return "NOT-FOUND"; // If instruction not found
    ...
    public static String getOpcode(String instr) {
        ...
        for (int i = 0; i < OPTAB.length; i++) {
            ...
            if (OPTAB[i][0].equals(instr)) {
                ...
                return OPTAB[i][2]; // Return the opcode
